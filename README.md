<h1 align="center">Gustavo Nicoletti</h1>

<p align="center">
  Full-stack developer building practical business systems with a growing focus on cybersecurity, secure software development and data protection.
</p>
...
My goal is to grow into roles that connect software engineering and cybersecurity, especially:
...
- receivables, payables and delinquency tracking;
- batch tuition generation with duplicate protection;
- financial dashboard with monthly comparison;
- permission-based access control;
- audit logging;
- XLSX/PDF reports;
- backend and frontend validation flows.

Repository: [school-finance-manager](https://github.com/GustavoNicoletti/school-finance-manager)
...
- building APIs with clear business rules;
